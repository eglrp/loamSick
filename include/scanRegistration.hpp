...
class scanRegistration{
    ...
    public:
        ...
        for (int i = 0; i < cloudSize; i++) {
            ...
            // float temptan  =  point.y/sqrt(pow(point.x,2)+pow(point.z,2));
            // //  float temptan  =  point.z/sqrt(pow(point.x,2)+pow(point.y,2));
            
            // if (temptan<0.0259 & temptan > 0.0159)
            //     scanID = 0;
            // else if (temptan < 0.0119 & temptan >0.0019)
            //     scanID = 1;
            // else if (temptan < -0.0019 & temptan >-0.0119)
            //     scanID = 2;
            // else if (temptan < -0.0159 & temptan >-0.0259)
            //     scanID = 3;
            // else
            //     continue;
