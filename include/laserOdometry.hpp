...
class laserOdometry{
    public:
        laserOdometry() : cornerPointsSharp(new pcl::PointCloud<PointType>()), cornerPointsLessSharp(new pcl::PointCloud<PointType>()),surfPointsFlat(new pcl::PointCloud<PointType>()),
        surfPointsLessFlat(new pcl::PointCloud<PointType>()),laserCloudCornerLast(new pcl::PointCloud<PointType>()),laserCloudSurfLast(new pcl::PointCloud<PointType>()),
        laserCloudOri(new pcl::PointCloud<PointType>()),coeffSel(new pcl::PointCloud<PointType>()),laserCloudFullRes(new pcl::PointCloud<PointType>()),
        imuTrans(new pcl::PointCloud<pcl::PointXYZ>()),kdtreeCornerLast(new pcl::KdTreeFLANN<PointType>()),kdtreeSurfLast(new pcl::KdTreeFLANN<PointType>())
        {
     ...
     laserOdometryBack laserOdometryHandler(const scanRegistrationBack& scanValueBack){ 
        ...
        int frameCount = skipFrameNum;
            ...
            if (laserCloudCornerLastNum > 5 && laserCloudSurfLastNum > 50) {
